# openapi_client.PIDManagementApi
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.PIDManagementApi(api_client)
    pid_record = openapi_client.PIDRecord() # PIDRecord | The body containing all PID record values as they should be in the new PIDs record.
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.PIDManagementApi(api_client)
    pid_record = openapi_client.PIDRecord() # PIDRecord | The body containing all PID record values as they should be after the update.
