...
class TabulatorPaginationFormatKnownPid(BaseModel):
    """
    TabulatorPaginationFormatKnownPid
    """ # noqa: E501
    data: Optional[List[KnownPid]] = None
    last_page: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["data", "last_page"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [KnownPid.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
