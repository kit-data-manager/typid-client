...
class PIDRecord(BaseModel):
    ...
    entries: Optional[Dict[str, List[PIDRecordEntry]]] = None
    __properties: ClassVar[List[str]] = ["pid", "entries"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each value in entries (dict of array)
        _field_dict_of_array = {}
        if self.entries:
            for _key_entries in self.entries:
                if self.entries[_key_entries] is not None:
                    _field_dict_of_array[_key_entries] = [
                        _item.to_dict() for _item in self.entries[_key_entries]
                    ]
            _dict['entries'] = _field_dict_of_array
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "entries": dict(
                (_k,
                        [PIDRecordEntry.from_dict(_item) for _item in _v]
                        if _v is not None
                        else None
                )
