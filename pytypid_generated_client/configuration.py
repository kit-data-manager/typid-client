...
AuthSettings = TypedDict(
    "AuthSettings",
    {
        "bearer-jwt": BearerFormatAuthSetting,
    },
    total=False,
)
...
class Configuration:
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor
        """
        self._base_path = "http://typed-pid-maker.datamanager.kit.edu/preview" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("pytypid_generated_client")
    ...
    def to_debug_report(self) -> str:
        ...
        return "Python SDK Debug Report:\n"\
               ...
               "SDK Package Version: 3.3.0-rc10".\
    ...
    def get_host_settings(self) -> List[HostSetting]:
        ...
        return [
            {
                'url': "http://typed-pid-maker.datamanager.kit.edu/preview",
